...
<section class="content-header">
    <h1>
        Jurusan        <small>List All Jurusan</small>
    </h1>
    <ol class="breadcrumb">
...
<section class="content">
    <div class="row">
        <div class="col-md-12">
         ...
         <div class="widget-user-header">
            <div class="row col-md-4 pull-right">
                        <a class="btn btn-primary" id="btn_add_new" href=""><i class="fa fa-plus-square-o" ></i> Add Jurusan</a>
        ...
        <h5 class="widget-user-desc">List All Jurusan <i class="label bg-yellow">items</i></h5>
        <hr>
  </div>
</div>
...
<div class="boxbox-widget widget-user-2">
                  <form name="form_Jurusan" id="form_Jurusan" action="">
