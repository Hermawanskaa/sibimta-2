...
<section class="content-header">
    <h1>
        Admin Dashboard      <small>Add Pembimbing</small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class=""><a  href="">Admin</a></li>
        <li class="active">Add Pembimbing</li>
    </ol>
</section>
        ...
        <div class="col-md-12">
            <div class="box box-info box-header with-border">
                <div class="box-body">
                    <div class="row">
                        <div class="widget-user-header">
                            ...
                            <h5 class="widget-user-desc">Add New Pembimbing</h5>
                            <hr>
                        </div>
                    </div>
                </div>
                ...
                <div class="boxbox-widget widget-user-2">
                    ...
                    <?php echo form_open_multipart(base_url('admin/pembimbing/add_pembimbing'),  'class="form-horizontal"');  ?>
                    <div class="box-body">
                    ...
                    <div class="box box-footer col-sm-offset-2 col-sm-8">
                        ...
                        <a class="btn btn-warning" href="<?= base_url('admin/pembimbing/list_pembimbing'); ?>"><i class="fa fa-undo" data-stype='back'></i> Back to List</a>
                    </div>
                    <?php echo form_close( ); ?>
                </div>
            </div>
