...
<section class="content-header">
    <h1>
        Kajur        <small>List All Kajur</small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class=""><a  href="">Kajur</a></li>
        <li class="active">List All Kajur</li>
    </ol>
</section>
...
<section class="content">
    <div class="row">
        <div class="col-md-12">
         ...
         <div class="widget-user-header">
            <div class="row col-md-4 pull-right">
                        <a class="btn btn-primary" id="btn_add_new" href=""><i class="fa fa-plus-square-o" ></i> Add Kajur</a>
        ...
        <h5 class="widget-user-desc">List All Kajur <i class="label bg-yellow">items</i></h5>
        <hr>
  </div>
</div>
...
<div class="boxbox-widget widget-user-2">
                  <form name="form_Kajur" id="form_Kajur" action="">
