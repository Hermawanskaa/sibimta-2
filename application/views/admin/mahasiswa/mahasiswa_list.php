...
<section class="content-header">
    <h1>
        Mahasiswa        <small>List All Mahasiswa</small>
    </h1>
    <ol class="breadcrumb">
...
<section class="content">
    <div class="row">
        <div class="col-md-12">
         ...
         <div class="widget-user-header">
            <div class="row col-md-4 pull-right">
                        <a class="btn btn-primary" id="btn_add_new" href=""><i class="fa fa-plus-square-o" ></i> Add Mahasiswa</a>
        ...
        <h5 class="widget-user-desc">List All Mahasiswa <i class="label bg-yellow">items</i></h5>
        <hr>
  </div>
</div>
...
<div class="boxbox-widget widget-user-2">
                  <form name="form_Mahasiswa" id="form_Mahasiswa" action="">
                  ...
                  <table class="table table-bordered table-striped dataTable">
                     ...
                     <tbody id="tbody_Mahasiswa">
                        <tr>
                         ...
                         <tr>
                           <td colspan="100">
                           Mahasiswa data is not available
                           </td>
                         </tr>
                     </tbody>
                  </table>
                  ...
                  <div class="col-md-8">
                     ...
                     <div class="col-sm-3 padd-left-0 ">
                        <select type="text" class="form-control chosen chosen-select" name="f" id="field" >
                           ...
                           <option value="id_member">NIM</option>
