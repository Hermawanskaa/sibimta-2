...
<section class="content-header">
   <h1>
      Skripsi      <small>Detail Skripsi</small>
   </h1>
   <ol class="breadcrumb">
...
<section class="content">
 ...
 <!-- Main Content -->              
                  <div class="form-horizontal" name="form_Skripsi" id="form_Skripsi" >
...
<!-- Footer Content -->
                    <div class="box box-footer">
                            ...
                            <i class="ion ion-ios-list-outline" ></i> Edit Skripsi
                            </button>
                            <button class="btn btn-default col" id="btn_cancel">
                            <i class="fa fa-undo"></i> Go Skripsi List
                            </button> 
                        </div>
                  </div>
               </div>
