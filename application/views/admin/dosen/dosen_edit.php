...
<?php if(isset($msg) || validation_errors() !== ''): ?>
            ...
            <?php endif; ?>
<?php echo form_open(base_url('admin/edit_dosen/'.$user['id_member']), 'class="form-horizontal"' )?>
    <div class="box-body">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-6">
          <input type="alamat" class="form-control" name="alamat" id="alamat" value="<?= $user['alamat']; ?>" placeholder="Alamat">
        </div>
      </div>
      <div class="form-group">
        <label for="no_hp" class="col-sm-2 control-label">No Hp</label>
        <div class="col-sm-6">
          <input type="no Hp" class="form-control" name="no_hp" id="no_hp" value="<?= $user['no_hp']; ?>" placeholder="Nomor Hp">
        </div>
      </div>
      <div class="form-group">
...
<!-- Footer Content -->
    <div class="box box-footer">
                            <button class="btn btn-primary" id="btn_save" type="submit" name="submit" value="Update User" data-stype='stay'>
