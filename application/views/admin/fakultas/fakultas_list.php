                    ...
                    <div class="row">
                        <div class="widget-user-header">
                            <div class="row col-md-2 pull-right">
                                <a class="btn btn-primary" id="btn_add_new" href="<?= base_url('admin/fakultas/add_fakultas'); ?>"><i class="fa fa-plus-square-o" ></i> Add Fakultas</a>
                            </div>
                            <div class="col-sm-1">
                            ...
                            <h5 class="widget-user-desc">List All Fakultas </h5>
                            <hr>
                        </div>
                    </div>
