...
<section class="content-header">
    <h1>
        Admin Dashboard    <small>Edit Fakultas</small>
    </h1>
    <ol class="breadcrumb">
        ...
        <div class="col-md-12">
            <div class="box box-info box-header with-border">
                <div class="box-body ">
                    <div class="row">
                        <div class="widget-user-header">
                            ...
                            <h5 class="widget-user-desc">Edit Fakultas</h5>
                            <hr>
                        </div>
                    </div>
                </div>
                ...
                <div class="boxbox-widget widget-user-2">
                    ...
                    <?php echo form_open_multipart(base_url('admin/fakultas/edit_fakultas/'.$user['fak_id']),  'class="form-horizontal"');  ?>
                    <div class="box-body">
                        <div class="form-group">
                            <label for="fak_id" class="col-sm-2 control-label">Nama</label>
                            <div class="col-sm-6">
                                <input type="input" class="form-control" name="fak_id" id="fak_id" placeholder="ID Fakultas" value="<?= $user['fak_id']; ?>" disabled>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="fak_nama" class="col-sm-2 control-label">Nama</label>
                            <div class="col-sm-6">
                                <input type="input" class="form-control" name="fak_nama" id="fak_nama" placeholder="Nama Fakultas" value="<?= $user['fak_nama']; ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="fak_kode" class="col-sm-2 control-label">Kode</label>
                            <div class="col-sm-6">
                                <input type="input" class="form-control" name="fak_kode" id="fak_kode" placeholder="Kode Fakultas" value="<?= $user['fak_kode']; ?>">
                            </div>
                        </div>
                    </div>
                </div>
