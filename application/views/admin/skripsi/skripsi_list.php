...
<section class="content-header">
    <h1>
        Skripsi        <small>List All Skripsi</small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class=""><a  href="">Skripsi</a></li>
...
<section class="content">
    <div class="row">
        ...
        <h5 class="widget-user-desc">List All Skripsi <i class="label bg-yellow">items</i></h5>
        <hr>
  </div>
</div>
...
<div class="boxbox-widget widget-user-2">
                  <form name="form_Skripsi" id="form_Skripsi" action="">
