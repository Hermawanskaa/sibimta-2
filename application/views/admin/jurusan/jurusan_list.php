                    ...
                    <div class="row">
                        <div class="widget-user-header">
                            <div class="row col-md-4 pull-right">
                                <a class="btn btn-primary" id="btn_add_new" href="<?= base_url('admin/jurusan/add_jurusan'); ?>"><i class="fa fa-plus-square-o" ></i> Add Data</a>
                            ...
                            <h5 class="widget-user-desc">List All Jurusan <i href="" class="label bg-yellow">items</i></h5>
                            <hr>
                        </div>
                    </div>
