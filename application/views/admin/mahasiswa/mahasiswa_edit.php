        ...
        <div class="col-md-12">
            <div class="box box-info box-header with-border">
                ...
                <div class="boxbox-widget widget-user-2">
                    ...
                    <?php echo form_open_multipart(base_url('admin/mahasiswa/edit_mahasiswa/'.$user['nim']),  'class="form-horizontal"');  ?>
                    <div class="box-body">
                        <div class="form-group">
                            <label for="nip" class="col-sm-2 control-label">NIP</label>
                            <div class="col-sm-6">
                                <input type="input" class="form-control" name="nip" id="nip" placeholder="NIP" value="<?= $user['nim']; ?>" disabled>
                            </div>
                        </div>
                        <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input type="number" class="form-control" name="level" id="level" placeholder="Level Admin" value="<?= $user['angkatan']; ?>">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="level" class="col-sm-2 control-label">Jurusan</label>
                        <div class="col-sm-6">
                            <input type="number" class="form-control" name="level" id="level" placeholder="Level Admin" value="<?= $user['jurusn']; ?>">
                        </div>
                    </div>
                    <div class="form-group">
